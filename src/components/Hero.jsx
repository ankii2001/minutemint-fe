          ...
          <div className="md:w-1/2 space-y-6 z-20">
            ...
            >
              ...
              <div className="hidden md:flex relative items-center justify-center">
                ...
                <span
                  className="
                    absolute inline-flex h-20 w-20 rounded-full bg-green-500 opacity-50
                ...
                <img
                  ...
                  className="relative w-35 h-35 rounded-full border-4 border-white shadow-lg"
                />
              </div>
            </div>
          </div>
